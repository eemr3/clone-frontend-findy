    ...
    <>
      <div className="bg-gray-800 py-3 pt-[2rem]">
        <div
          ...
          ${props.showJustify ? "" : " w-[100%!important] pr-[2rem]"}
          `}
        >
          ...
          <nav className={"mt-5 flex gap-[2rem] pl-[5rem] lg:hidden"}>
            <Button>
            ...
            <>
             <Button >
              <Link to="/project"><p>novo projeto</p> </Link>
            </Button>
            <Button >
              <Link to="/profile"><p> profile</p></Link>
            </Button>
            <Button >
              <Link to="/project_registered"> <p>  Projetos Registrados</p>
             </Link>
            </Button>

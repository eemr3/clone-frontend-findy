      ...
      <div className="flex h-[6.631rem]   rounded-[0.6rem] border-[0.1rem] border-grey-#1  bg-white sm:max-w-[100%] mbl:h-[4rem] mbl:max-h-[3rem]  mbl:w-[25rem] mbl:max-w-[80%] ">
        ...
        {!options.length && whenListIsEmpty === "Spinner" ? (
          ...
          <select
            ...
            ref={ref}
            className={`${className} text-[2.4rem]border-none ml-[2rem] w-[32.5rem] bg-white  text-[2.4rem]  font-medium leading-[2.831rem] tracking-[-0.5%] text-grey-#1 outline-none placeholder:text-grey-#2 sm:max-w-[100%] mbl:w-[100%] mbl:max-w-[100%] mbl:max-w-[17rem] mbl:text-[1.2rem]`}

  ...
  return (
    <div className="w-max-[144rem] flex flex-col bg-blue-dark">
      ...
      <section className="mt-[10.2rem] bg-grey-#5 ">
        ...
        >
          <div className="grid grid-cols-2 gap-[20rem] gap-y-[6.469rem] lg:flex lg:flex-col lg:items-start lg:justify-center lg:gap-y-[5.469rem] lg:px-[4rem] mbl:gap-y-[4rem]  mbl:px-[2rem]  ">
            <InputDBRefact
              type='text'
              icon={<PencilIcon />}
              label="Nome completo"

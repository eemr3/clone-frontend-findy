...
export function Cadastro() {
  ...
  return (
    <div className="w-max-[1483px] flex h-[100%] flex-col overflow-x-hidden bg-blue-dark opacity-90">
      <Header />
      <div className="my-auto flex flex-col justify-center items-center pt-[4.14rem] xl:w-[100%] xl:justify-center md:px-[2rem] mbl:px-[1.5rem] ">
      <h1 className="text-[2.4rem] text-grey-#4 mb-[1.1rem]">Crie uma Conta</h1>
        <form
          className="flex  w-[100%] max-w-[63.5rem] flex-col items-center rounded-[2.6rem] bg-[#FFFFFF] shadow-shadow-#2-card "
          onSubmit={handleSubmit(handleSubmitRegister)}
        >
          <div className="w-[70%] mt-[5rem] sm:justify-center  mbl:w-[85%]  ">
            <input
              type="name"
              placeholder="Nome"
              {...register("name")}
              className={
                errors.name
                  ...
                  : "mb-[1.49rem] h-[4.7rem] w-[100%] rounded-[0.8rem] focus:border-green-medium border border-grey-#2 pl-[2.06rem] text-[2.4rem] mbl:h-[4.5rem] mbl:w-[100%] mbl:text-[1.3rem]"
              }
            />
        ...
        <div className="w-[70%]  sm:justify-center  mbl:w-[85%]  ">
          <input
            ...
            className={
              errors.email
                ? "h-[4.7rem] w-[100%] rounded-[0.8rem] border border-red pl-[2.06rem] text-[2.4rem] placeholder-grey-#2 mbl:h-[4.5rem] mbl:w-[100%] mbl:text-[1.3rem]"
                : "mb-[1.49rem] h-[4.7rem] w-[100%] rounded-[0.8rem] border border-grey-#2 focus:border-green-medium pl-[2.06rem] text-[2.4rem] mbl:h-[4.5rem] mbl:w-[100%] mbl:text-[1.3rem]"
            }
          />
          <span className=" mb-[1rem] mt-[0.8rem] block  pl-[1rem] text-[1.8rem] text-red">
            {
          ...
          <input
            ...
            className={
              errors.password
                ...
                : "h-[4.7rem] w-[100%] rounded-[0.8rem] border border-grey-#2 focus:border-green-medium pl-[2.06rem] text-[2.4rem] mbl:mr-[1rem] mbl:h-[4.5rem] mbl:w-[100%] mbl:text-[1.3rem]"
            }
          />
        ...
        <div className="w-[70%] mt-[1.54rem] sm:justify-center mbl:flex mbl:w-[85%]">
          <input
            type="password"
            ...
            className={
              errors.confirmPassword
                ...
                : "h-[4.7rem] w-[100%] rounded-[0.8rem] border border-grey-#2 focus:border-green-medium pl-[2.06rem] text-[2.4rem] mbl:h-[4.5rem] mbl:w-[100%] mbl:text-[1.3rem]"
            }
          />
          <span className=" mb-[1rem] mt-[0.8rem] block  pl-[1rem] text-[1.8rem] text-red">
            {errors.confirmPassword
        ...
        <div className="flex w-[70%] mt-[1.39rem] mbl:w-[76%]">
          <div className="flex gap-[1.5rem]">
            <div 
              className={
                errors.accept_terms
                ? "h-[4.0rem] w-[4.0rem] border-[2px] border-red rounded-lg"
                : "h-[4.0rem] w-[4.0rem] border-[2px] border-green-medium rounded-lg"
              }
            >
              <input
                className="mr-[1.2rem] h-[3.6rem] w-[3.6rem] accent-[#01A195] rounded-lg"
                type="checkbox"
                checked={isChecked}
        ...
        <button
          type="submit"
          className="mdl:mt-[3rem] mt-[3.95rem] h-[6rem] w-[60%] rounded-[3.2rem] bg-[#01A195] hover:bg-green-dark duration-700 mbl:h-[4rem] text-[2.4rem] text-[#FFFFFF]"
          disabled={activeSubmit}
        >
          Criar conta
        </button>
        <p className="flex flex-col items-center mdl:mb-[3rem] mb-[6rem] mt-[2.4rem] text-[2.4rem] text-grey-#1 mbl:text-[2rem]">
          Já possui uma conta?{" "}

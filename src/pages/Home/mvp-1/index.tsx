      ...
      <div className="w-max-[144rem]  h-[calc(100vh - 10rem)]  border-none bg-blue-dark pt-[10rem]">
        {larguraTela > 1350 ? (
          <div className=" flex h-[90%] items-center xl:flex xl:flex-col-reverse xl:items-start ">
            <div className="ml-[12.909rem] flex w-[53rem] flex-col md:ml-[0] md:w-[80%] 2xl:w-[40%]   4xl:ml-[25rem] 4xl:w-[70%] 3xl:ml-[10rem]">
              ...
              <span className="mt-[3.2rem] inline-block w-[45.8rem] text-[3.4rem] font-medium text-grey-#5 md:w-[100%]  ">
                Você é um jovem talento em busca de experiências na área de tecnologia?
                Então conheça a Findy!
              </span>
          ...
          <div className=" flex h-[90%]  items-center xl:flex xl:flex-col-reverse">
            <div className="ml-[12.909rem] flex w-[53rem] flex-col md:w-[80%] lg:ml-[0] 2xl:ml-[7rem] 2xl:w-[80%]  4xl:ml-[25rem] 4xl:w-[70%] 3xl:ml-[17rem] ">

...
import mulherPagePrincipal2 from "../../../assets/mulher-page-principal2.svg";
    ...
    <section className="h-[100%] bg-blue-dark ">
      ...
      <div className="w-max-[144rem]  h-[100%-10rem)]  bg-blue-dark">
          ...
          <div className=" flex h-[90%]  items-center xl:flex xl:flex-col-reverse ">
            <div className="ml-[12.909rem] flex w-[53rem] flex-col md:ml-[0] md:w-[80%] 4xl:w-[70%] 3xl:ml-[17rem]  4xl:ml-[25rem] 2xl:ml-[7rem] 2xl:w-[40%]">
            ...
            <Button
              fill={true}
              className="mt-[6.4rem] mb-[4rem] h-[4.2rem] w-[35.6rem]"
            >
          ...
          <img
            ...
            className=
                 ...
                 "absolute right-[4rem] top-[-1rem] h-[110rem] w-[60rem] object-cover md-h:h-[80rem]"
        ...
        <img
        src={
          larguraTela > 1350 ? mulherPagePrincipal : mulherPagePrincipal2
        }
        alt="mulher"
        className={
          larguraTela > 1350

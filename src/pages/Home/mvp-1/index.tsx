...
import mulherPagePrincipal2 from "../../../assets/woman.png";
    ...
    <section className="h-[100%] bg-blue-dark ">
      ...
      <div className="w-max-[144rem]  h-[100%-10rem)]  bg-blue-dark">
        <div className=" flex h-[90%]  items-center xl:flex xl:flex-col-reverse ">
          ...
          <img
            src={
              larguraTela > 1380 ? mulherPagePrincipal : mulherPagePrincipal2
            }
            alt="mulher"
            className={
              larguraTela > 1380
                ? "absolute right-[1rem] top-[0] h-[110rem] w-[70rem] object-cover md-h:h-[80rem]"
                : "left-[61.215rem]"
            }
          />
          {/*    </div> */}

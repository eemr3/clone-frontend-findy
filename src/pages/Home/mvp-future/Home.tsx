    ...
    <div className="w-max-[144rem] flex flex-col">
      ...
      <main>
        ...
        <section className="relative z-20 mx-auto mt-[-20.9rem] flex h-[39.6rem] w-[120rem] flex-col items-center rounded-[2.6rem] bg-grey-#5 shadow-shadow-#3">
          <Heading type="sm" className="text-black mt-[4rem]">
            Encontre a melhor oportunidade
          </Heading>

          <form
            action=""
            className="bg-white border-black mt-[4rem] flex w-[83.8rem] items-center gap-[1.6rem] rounded-[1.642rem] border-[0.088rem] px-[2.463rem] py-[1.642rem]"
          >
            <Input
              className="w-[24.4rem]"

...
export function ProfessionalAchievement({ nextStep }: ProfessionalAchievementProps) {
  ...
  return (
    <form className="mx-auto mt-[2rem] flex flex-col items-center h-screen w-[66rem]" noValidate>
    <h1 className="text-[2.4rem] text-grey-#4 mt-[3.357rem]">Realização profissional e motivações.</h1>
          ...
          <div className='flex flex-col items-center'>
            ...
            <div
              className={`w-8 h-8 rounded-full ${
                selected === 0 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
              }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 1 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 2 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 3 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 4 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 5 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 6 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 7 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 8 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 9 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
            ...
            <div className='flex flex-col items-center'>
              ...
              <div
                className={`w-8 h-8 rounded-full ${
                  selected === 10 ? 'border border-green-medium bg-green-dark' : selected === null && isButtonClicked ? 'border border-red' : 'border border-green-medium'
                }`}
      ...
      <textarea
        className={`p-2 h-[7.2rem] w-[50.6rem] text-[1.4rem] text-grey-#2 rounded-lg border ${
          errors.feedback || (isButtonClicked && !feedback) ? 'border-red' : 'border-[#000000]'
        }`}
      ...
      <span className={`text-[1.4rem] ${
          errors.feedback || (isButtonClicked && !feedback) ? 'text-red' : 'text-[#000000]'
        }`}>
        *Campos obrigatórios
      </span>
